...
function index() {
  const FaqList = [
    {
      title: "1. 코치미 멤버가 되면 어떤 혜택이 있나요?",
      text: (
        <>
          <p>
            <strong>문화모임</strong> 월 1회, 총 4번의 코치미 문화모임에
            참여하게 됩니다. (일부 6회)
          </p>
          <p>
          ...
          <p>
            <strong>아지트</strong> 코치미 멤버가 모여 함께 하고 놀 수
            있는 공간이 제공돼요.
          </p>
        </>
      )
